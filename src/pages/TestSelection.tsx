          ...
          {tests.map((test) => (
            ...
            >
              <div className="flex items-start gap-4">
                ...
                <div className="flex-1">
                  ...
                  <div className="mt-4 flex flex-wrap gap-2">
                    {test.dimensions.map((dim) => (
                      <span
                        key={dim}
                        className="px-2 py-1 bg-cream-dark/50 rounded-full text-xs text-brown-light"
                      >
                        {dim}
                      </span>
                    ))}
                ...
                <ArrowRight className="w-5 h-5 text-brown-light group-hover:text-teal group-hover:translate-x-1 transition-all" />
              </div>
            </Link>
          ))}
        </div>
